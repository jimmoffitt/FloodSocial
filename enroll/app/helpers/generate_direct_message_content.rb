class GenerateDirectMessageContent
	...
	def generate_system_help(recipient_id)
		...
		message_text = "This prototype bot supports several commands. Commands are made by sending a Direct Message including these (case-insensitive) keywords:
